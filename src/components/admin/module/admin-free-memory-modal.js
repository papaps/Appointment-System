            ...
            <>
                ...
                <Modal 
                    ...
                    <Modal.Content>
                        ...
                        <p style={paragraph_style}>This program was designed to handle 512MB to maintain the free service. We will warn every year to delete past appointments made 5 years ago and beyond. We strongly recommend to continue this action.</p>
                    </Modal.Content>


                    <Modal.Actions>
                        <Button icon labelPosition='left' color="red" id="create-procedure-button">
                            <Icon name='trash' />
                            DELETE
                        </Button>
                    </Modal.Actions>
