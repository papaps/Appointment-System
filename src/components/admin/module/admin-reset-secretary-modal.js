...
class AdminResetSecretaryModal extends React.Component{
    ...
    handleSubmit = event =>{
        ...
        axios.post('admin/updateAccountPassword', data)
            .then(res=>{
                console.log(res)
    ...
    render(){
        ...
        return(
            <Modal 
                ...
                <Modal.Content>
                    <Form onSubmit={this.handleSubmit}>
                        <Form.Field required id="sec-current-password-field" >
                            ...
                            <Input name="currentPassword" type="password" id="sec-current-password" autoComplete="false" placeholder="Confirm Password" onChange={this.handleChange}/>
                        </Form.Field>
                        <Form.Field required id="sec-new-password-field" >
                            <label>New Password</label>
                            <Popup
                                trigger={<Input name="newPassword" type="password" id="sec-new-password" autoComplete="false" placeholder="New Password" onChange={this.handleChange}/>}
                        ...
                        <Form.Field required id="sec-confirm-new-password-field">
                            ...
                            <Popup
                                trigger={<Input name="confirmNewPassword" type="password"id="sec-confirm-new-password" autoComplete="false" placeholder="Confirm New Password" onChange={this.handleChange} />}
                                content='Password should contain 10 to 32 alphanumeric characters'
                                position='right center'
                                />
                        </Form.Field>
                ...
                <Modal.Actions>
                    <Button icon labelPosition='left' color="green" id="sec-save-password" onClick={this.handleSubmit}>
                        <Icon name='check' />
                        CONFIRM
                    </Button>
                </Modal.Actions>
