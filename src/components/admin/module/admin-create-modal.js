        ...
        return(
            <>
                ...
                <Modal 
                    ...
                    <Modal.Header className = "center-header" as="h2">What would you like to create?</Modal.Header>
                    
                    <Modal.Actions>
                        <Grid centered columns={2} >
                            <Grid.Column style={column_style}>
                                <Button id="add-dentist-button" onClick={()=>this.handleModal("admin-add-dentist")}>
                            ...
                            <Grid.Column style={column_style}>
                                <Button id="add-procedure-button" onClick={()=>this.handleModal("admin-add-procedure")}>
                                    <Segment basic style={segment_style}>
                                        <Icon name="clipboard" size="large"></Icon>
                                    </Segment>
                                    New Procedure
                                </Button>
                            </Grid.Column>
